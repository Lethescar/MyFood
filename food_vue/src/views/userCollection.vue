                ...
                <el-tab-pane label="我收藏的食谱" name="first" class="dheader">
                    <div class="line"></div>
                     <div class="menu-content" v-if="list">
                        <div v-for="(item,index) in list" :key="index" class="menu_con">
                        <router-link :to="`/menuDetail/${item.mid}`">
...
`+item.img" alt="">
                ...
                <el-tab-pane label="我收藏的文章" name="second" class="dheader">
                     ...
                     <div class="menu-content" v-if="list">
                     <div  v-for="(item,index) in list" :key="index" class="menu_con">
                        <router-link :to="`/article/${item.lcId}`">
                            <div class="menu-content-item">
                                <div class="img_div">
...
-active {color: #d8316c;cursor: pointer;}
   ...
   .menu_con{width:23%;padding-left: 1%;padding-right: 1%;}
    .menu-content a{display: block;text-decoration: none;width:100%;}
